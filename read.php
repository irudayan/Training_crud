                    ...
                    <form name="insertrecord" method="post" class="register-form" id="register-form">
                        <h2>student registration form</h2>
                          <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="allowtypes" name="name" id="name" value="<?php echo htmlentities($row['Name']);?>" disabled/>
                            </div>
                            <div class="form-group">
                                <label for="fathername">Father Name :</label>
                                <input type="text" class="allowtypes" name="fathername" value="<?php echo htmlentities($row['FatherName']);?>" id="father_name" disabled/>
                            </div>
                        </div>
                        ...
                        <div class="form-radio">
                            ...
                            <div class="form-radio-item">
                                <input type="radio" name="gender" id="male" value="male" <?php if ($row['Gender'] == 'male') {?>checked<?php } ?> disabled>
                                <label for="male" >Male</label>
                                <span class="check"></span>
                            </div>
                            <div class="form-radio-item">
                                <input type="radio" name="gender" value="female" id="female" <?php if ($row['Gender'] == 'female') {?>checked<?php } ?> disabled>
                        ...
                        <div class="form-group" id="datepicker" >
                            ...
                            <input type="text"  name="dob" data-bind="value: startDate, event: {change: savePerishableDate}" id="date" placeholder="dd/mm/yyyy" value="<?php echo htmlentities($row['DOB']);?>" disabled/>
                        </div>
                        

                        <div class="form-group">
                            <label for="address">Address :</label>
                            <textarea class="form-control" name="address" rows="3" cols="69" id="address" disabled><?php echo htmlentities($row['Address']);?> </textarea>
                        ...
                        <div class="form-row">
                            ...
                            <input type="email" name="emailid" id="email" value="<?php echo htmlentities($row['EmailId']);?>" disabled />
                            </div>
                            <div class="form-group">
                                <label for="city">Contactno :</label>
                               <input type="text" name="contactno" id="number" maxlength="10" value="<?php echo htmlentities($row['ContactNumber']);?>" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" disabled>
                            </div>
                        </div>
